package com.example.tinyurl.zookeeper;
...
public class DistributedLock {
    ...
    public DistributedLock(ZooKeeperConnection connection, String lockBasePath, String lockName) throws IOException, InterruptedException {
        this.zk = connection.getZk();
